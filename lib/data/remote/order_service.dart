...
class OrderService{
  ...
  Future<Response> addToCart(Product product){
    return BookClient.instance.dio.post("/order/add",data: product.toJson(),);
  }

  Future<Response> orderDetail(String orderId){
    return BookClient.instance.dio.get("/order/detail",queryParameters: {
      "order_id":orderId,
    });
  }

  Future<Response> updateOrder(Product product){
    return BookClient.instance.dio.post("/order/update",data: {
  ...
  Future<Response> confirm(String orderId){
    return BookClient.instance.dio.post("/order/confirm",data: {
      "orderId": orderId,
      "status": "CONFIRM",
    });
  }
